...
// ==========================================
// File ini berisi perbaikan untuk masalah zona waktu WIB di aplikasi
// Copy-paste fungsi-fungsi ini ke database-storage.ts di aplikasi yang sudah di-deploy
...
async getTherapySlotsByDate(date: Date | string): Promise<TherapySlot[]> {
  ...
  // Lanjutan kode sama seperti fungsi asli...
  // ...
